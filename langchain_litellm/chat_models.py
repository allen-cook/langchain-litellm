...
class ChatLitellm(BaseChatModel):
    ...
    """Litellm chat model integration.

    The default implementation echoes the first `parrot_buffer_length` characters of the input.

    # TODO: Replace with relevant packages, env vars.
    Setup:
        Install ``langchain-litellm`` and set environment variable ``LITELLM_API_KEY``.
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            Litellm API key. If not passed in will be read from env var LITELLM_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatLitellm.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatLitellm.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatLitellm supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatLitellm supports async generation. Otherwise delete.
