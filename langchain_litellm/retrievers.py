...
class LitellmRetriever(BaseRetriever):
    ...
    Setup:
        Install ``langchain-litellm`` and set environment variable
        ``LITELLM_API_KEY``.
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain-litellm import LitellmRetriever

            retriever = LitellmRetriever(
                # ...
            )
