...
class LitellmToolInput(BaseModel):
    """Input schema for Litellm tool.
...
class LitellmTool(BaseTool):  # type: ignore[override]
    """Litellm tool.
    ...
    args_schema: Type[BaseModel] = LitellmToolInput
